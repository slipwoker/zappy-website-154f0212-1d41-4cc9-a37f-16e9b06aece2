...
document.addEventListener('DOMContentLoaded', function() {
  ...
  if (contactForm) {
    contactForm.addEventListener('submit', function(e) {
      ...
      const message = formData.get('message') || formData.get('msg') || formData.get('content') || '';
        ...
        (async function() {
          try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
              ...
              body: JSON.stringify({
                websiteId: '154f0212-1d41-4cc9-a37f-16e9b06aece2',
                name: name,
                email: email,
                subject: subject,
                message: message,
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "KB-TECH משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
